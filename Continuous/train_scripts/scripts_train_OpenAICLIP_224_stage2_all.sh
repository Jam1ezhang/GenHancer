...
accelerate launch --config_file "train_configs/accelerate_config.yaml" train_OpenAICLIP_indefinite_length_sliding_windows_nextpredic_stage2_all.py --config "train_configs/test_OpenAICLIP_224_stage2_all_indefinite_length_sliding_window.yaml"
