...
def build_windows_with_mask(
    ...
    Returns:
      ...
      bs_eff: total effective windows
    """
...
def main():
    ...
    if hasattr(args, "load_dir") and hasattr(args, "load_step"):
        ...
        # project_clip (optional; your sliding-window stage1 didn't save it, so load only if exists)
        ...
        for step, batch in enumerate(train_dataloader):
            try:
                ...
                with accelerator.accumulate(super_model):
                    ...
                    # ---------------------------------------------------------
                    # NOTE: prepare_clip is used to produce correct-shaped img_ids for FLUX
